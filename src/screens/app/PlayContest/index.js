    ...
    <SafeAreaView style={styles.container}>
      ...
      {expandImage ? (
        <View
          ...
          onStartShouldSetResponder={() => setExpandImage(null)}
        >
          <View style={styles.closeHeader}>
            <TouchableOpacity
              style={styles.closeBtn}
              onPress={() => setExpandImage(null)}
              activeOpacity={1}
            >
      ...
      >
        ...
        <View style={styles.modalFooter}>
          <TouchableOpacity style={styles.btnDefault} onPress={_navigatePrev}>
            <Text style={styles.btnDefaultTxt}>
              {/* {localized_strings.quit} */}
              quit
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.btnDefault, styles.bgTheme]}
            onPress={() => setModalVisible(!modalVisible)}
          >
            <Text style={[styles.btnDefaultTxt, styles.clrWhite]}>
      ...
      ) : contest_questions && contest_questions.length ? (
        contest_questions.map((item, i) => {
          console.log("Testing");
